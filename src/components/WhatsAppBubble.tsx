...
export default function WhatsAppBubble() {
  ...
  return (
    <a
      ...
      className={`wa-bubble group hidden md:flex fixed bottom-6 right-6 z-30 items-center gap-0 rounded-full bg-[#25d366] text-white shadow-[0_8px_24px_rgba(37,211,102,0.35)] transition-all duration-300 hover:bg-[#1ebe5b] hover:shadow-[0_10px_28px_rgba(37,211,102,0.45)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25d366] ${
        visible ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-4 opacity-0"
      }`}
    >
      <span className="relative flex h-14 w-14 shrink-0 items-center justify-center">
        <span className="wa-bubble__pulse absolute inset-0 rounded-full bg-[#25d366]" aria-hidden="true" />
        <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="relative">
      ...
      <span className="max-w-0 overflow-hidden whitespace-nowrap pr-0 text-[0.95rem] font-bold tracking-[0.01em] transition-all duration-300 group-hover:max-w-[16rem] group-hover:pr-6 group-focus-visible:max-w-[16rem] group-focus-visible:pr-6">
