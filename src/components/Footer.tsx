      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 pt-14 pb-10">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-t border-brass/25 py-12 text-sm sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            {/* Une grille plutôt que des liens en ligne : chacun garde sa ligne,
                quelle que soit la longueur du libellé ou la largeur de l'écran. */}
            <div className="mt-4 grid justify-items-start gap-2">
              {site.social.instagram && (
                <a
                  href={site.social.instagram}
                  rel="me noopener"
                  className="inline-flex w-fit items-center gap-2 hover:text-brass-2"
                >
